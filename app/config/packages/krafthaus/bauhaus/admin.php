...
return [
	 ...
	 * @var string
	 */
	'title' => 'Exodus Management Portal',
	 ...
	 */
	'menu' => [
            array('title' => 'Users', 'class' => 'User','icon'  => 'user'),
            array('title' => 'Clients', 'class' => 'Clients','icon'  => 'group'),
            array('title' => 'Tickets', 'class' => 'Tickets','icon'  => 'warning')
	],
	...
	'dashboard' => [
		'top' => [
			[
				...
				'content' => '
					<h3>Welcome to the Exodus dashboard.</h3>
					<p>To begin, please select a function above.</p>
				'
			]
		]
	],
